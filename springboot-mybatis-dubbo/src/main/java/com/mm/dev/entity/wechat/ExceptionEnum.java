...
public enum ExceptionEnum {
	...
	/** 商品价格已改动 */
	product_price_different("商品价格已变动","3012"),
	/** 栏目编号不存在 */
	...
	/** 新增分享记录失败 */
	fenxiang_is_low("分享失败 ","3025"),
	/** 该商户已存在 */
	merchat_is_exist("该商户已存在 ","3024"),
	/** 会员id为空 */
	member_id_null("该会员id为空 ","3025"),
	/** 该人已被推荐 */
	referee_is_exist("该人已被推荐  ","3026"),
	/** 验证码未超过10分钟不能重新发送 */
	validate_code_noReady_send2("验证码未超过10分钟不能重新发送","3027"),
	
	/** 该银行卡号不存在 */
	cardNo_is_not_exist("该银行卡号不存在 ","3028")
	;
